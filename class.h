...
/* -> we do not use debug structures yet (i.e. line_number_table and local_variable_table)
...
typedef struct sCONSTANT_Fieldref_info
{
	...
	struct sClass* class; /* resolved symbolic references */
	struct sVariable* variableInfo;
